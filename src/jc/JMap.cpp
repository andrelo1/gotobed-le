...
namespace jc::JMap
{
	...
	std::int32_t getInt(void* a_domain, std::int32_t a_obj, BSFixedString a_key, std::int32_t a_default)
	{
		return ApiStorage::get().JMap_getInt(a_domain, a_obj, a_key, a_default);
	}

	float getFlt(void* a_domain, std::int32_t a_obj, BSFixedString a_key, float a_default)
	{
	...
	std::int32_t getObj(void* a_domain, std::int32_t a_obj, BSFixedString a_key, std::int32_t a_default)
	{
		return ApiStorage::get().JMap_getObj(a_domain, a_obj, a_key, a_default);
	}

	TESForm* getForm(void* a_domain, std::int32_t a_obj, BSFixedString a_key, TESForm* a_default)
	{
