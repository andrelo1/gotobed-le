...
namespace jc::JArray
{
	...
	void addFromFormList(void* a_domain, std::int32_t a_obj, BGSListForm* a_source, std::int32_t a_insertAtIndex)
	{
	...
	TESForm* getForm(void* a_domain, std::int32_t a_obj, std::int32_t a_index, TESForm* a_default)
	{
	...
	std::int32_t findStr(void* a_domain, std::int32_t a_obj, BSFixedString a_value, std::int32_t a_searchStartIndex)
	{
	...
	std::int32_t findForm(void* a_domain, std::int32_t a_obj, TESForm* a_value, std::int32_t a_searchStartIndex)
	{
	...
	void addStr(void* a_domain, std::int32_t a_obj, BSFixedString a_value, std::int32_t a_index)
	{
	...
	void addForm(void* a_domain, std::int32_t a_obj, TESForm* a_value, std::int32_t a_index)
	{
	...
	bool writeToIntegerPArray(void* a_domain, std::int32_t a_obj, VMArray<std::int32_t> a_targetArray, std::int32_t a_writeAtIdx, std::int32_t a_stopWriteAtIdx, std::int32_t a_readIdx, std::int32_t a_defaultRead)
	{
	...
	bool writeToFloatPArray(void* a_domain, std::int32_t a_obj, VMArray<float> a_targetArray, std::int32_t a_writeAtIdx, std::int32_t a_stopWriteAtIdx, std::int32_t a_readIdx, float a_defaultRead)
	{
	...
	bool writeToFormPArray(void* a_domain, std::int32_t a_obj, VMArray<TESForm*> a_targetArray, std::int32_t a_writeAtIdx, std::int32_t a_stopWriteAtIdx, std::int32_t a_readIdx, TESForm* a_defaultRead)
	{
	...
	bool writeToStringPArray(void* a_domain, std::int32_t a_obj, VMArray<BSFixedString> a_targetArray, std::int32_t a_writeAtIdx, std::int32_t a_stopWriteAtIdx, std::int32_t a_readIdx, BSFixedString a_defaultRead)
	{
